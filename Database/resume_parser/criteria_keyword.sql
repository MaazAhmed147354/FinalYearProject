...
--
-- Table structure for table `criteria_keywords`
--

DROP TABLE IF EXISTS `criteria_keywords`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;

CREATE TABLE `criteria_keywords` (
...
--
-- Dumping data for table `criteria_keywords`
--
